...
class Game:
    ...
    def in_world(self):
        ...
        choice = self.player.get_input("Choose an action: ", ["1", "2", "3", "4"])
...
character = characters.Character(name, max_hp=100, attack=3, defense=1, speed=1, type=characters.Colour.random_type(), runes=[data.power_rune])
